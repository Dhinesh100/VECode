        ...
        <div>
            ...
            <div className="d-flex justify-content-around flex-column align-items-center ml-2 mr-2">
                ...
                <div className="d-flex justify-content-around">
                    <img src={gold} style={{width: '3.5em', height: '3.5em'}} alt="Gold Medal" />
                </div>
                ...
                <div className="d-flex justify-content-around">
                    <img variant="top" src={silver} style={{width: '3.5em', height: '3.5em'}} alt="Silver Medal" />
                </div>
                ...
                <div className="d-flex justify-content-around">
                    <img variant="top" src={bronze} style={{width: '3.5em', height: '3.5em'}} alt="Bronze Medal" />
                </div>
